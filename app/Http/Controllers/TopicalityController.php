...
use App\Http\Resources\Topicality as TopicalityResources;
...
class TopicalityController extends Controller
{
    ...
    public function index()
    {
        ...
        return TopicalityResources::collection(Topicality::orderByDesc('created_at')->get());
    }
    ...
    {
        return new TopicalityResources($topicality);
    }
